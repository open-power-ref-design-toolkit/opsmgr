...
#report = subprocess.check_output(["/usr/bin/swift-dispersion-report -j"],shell=True)
#report = subprocess.call(["/usr/bin/swift-dispersion-report -j"],shell=True,stdout=subprocess.PIPE)
p = subprocess.Popen(["/usr/bin/swift-dispersion-report","-j"],shell=False,stdout=subprocess.PIPE)
