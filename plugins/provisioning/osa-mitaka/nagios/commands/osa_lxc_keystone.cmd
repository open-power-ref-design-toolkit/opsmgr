...
command[osa_lxc_ad] = sudo /etc/nagios/plugins/check-lxc.sh keystone check-procs.rb '-p keystone-ad -w 50 -c 100 -W 1 -C 1'
command[osa_lxc_se] = sudo /etc/nagios/plugins/check-lxc.sh keystone check-procs.rb '-p keystone-se -w 50 -c 100 -W 1 -C 1'
...
command[osa_lxc_ntp]         = sudo /etc/nagios/plugins/check-lxc.sh keystone check-ntp.rb ''
...
command[osa_lxc_dbus]        = sudo /etc/nagios/plugins/check-lxc.sh keystone check-procs.rb '-p dbus-daemon -w 15 -c 30 -W 1 -C 1'
