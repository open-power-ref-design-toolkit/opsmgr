...
command[osa_lxc_ntp] = sudo /etc/nagios/plugins/check-lxc.sh nova_scheduler check-ntp.rb ''
...
command[osa_lxc_dbus] = sudo /etc/nagios/plugins/check-lxc.sh nova_scheduler check-procs.rb '-p dbus-daemon -w 15 -c 30 -W 1 -C 1'
