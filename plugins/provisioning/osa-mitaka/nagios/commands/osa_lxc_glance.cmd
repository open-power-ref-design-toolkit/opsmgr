...
command[osa_lxc_rpcstatd] = sudo /etc/nagios/plugins/check-lxc.sh glance check-procs.rb '-p rpc.statd -w 15 -c 30 -W 1 -C 1'
...
command[osa_lxc_ntp]         = sudo /etc/nagios/plugins/check-lxc.sh glance check-ntp.rb ''
...
command[osa_lxc_dbus]        = sudo /etc/nagios/plugins/check-lxc.sh glance check-procs.rb '-p dbus-daemon -w 15 -c 30 -W 1 -C 1'
