...
command[server-rsyslogd] = sudo /etc/nagios/plugins/check-procs.rb -p rsyslogd -w 30 -c 40 -W 1 -C 1
command[server-sshd]     = sudo /etc/nagios/plugins/check-procs.rb -p sshd -w 30 -c 40 -W 1 -C 1
