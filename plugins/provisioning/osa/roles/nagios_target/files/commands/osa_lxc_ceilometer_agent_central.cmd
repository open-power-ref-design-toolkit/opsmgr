...
command[osa_lxc_ntp] = sudo /etc/nagios/plugins/check-lxc.sh ceilometer_agent_central check-ntp.rb ''
...
command[osa_lxc_procs] = sudo /etc/nagios/plugins/check-lxc.sh ceilometer_agent_central check-procs.rb '-p ceilometer -w 15 -c 30 -W 1 -C 1'
...
command[osa_lxc_dbus] = sudo /etc/nagios/plugins/check-lxc.sh ceilometer_agent_central check-procs.rb '-p dbus-daemon -w 15 -c 30 -W 1 -C 1'
